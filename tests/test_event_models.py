...
@pytest.mark.parametrize(
    ...
    [
        ({"type": "observation", "station_id": "KMIA", "temperature_f": 81.2}, Observation),
        (
            {
                "type": "price_update",
                "station_id": "KMIA",
        ...
        ({"type": "oracle_scores_updated", "station_id": "KMIA", "modes": ["overall"]}, OracleScoresUpdated),
        ...
        ({"type": "new_high", "station_id": "KMIA", "value_f": 92.1, "value_c": 33.4}, NewHigh),
