//! Station, Kalshi city-code and series-ticker lookups for the weather Markets.
//!
//! Ported unchanged from the legacy contract. Unknown stations fall back to the ICAO code
//! without its leading `K`; hourly series are listed only for verified settlement profiles.
